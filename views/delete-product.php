<?php
    ...
    $pruduct_obj = new Product;
    $product_id = $_GET['product_id'];
    $product = $pruduct_obj->getProduct($product_id);
?>
...
<body>
    ...
    <main class="row justify-content-center gx-0">
        <div class="col-4 text-center">
            ...
            <p class="fw-bold">Are you sure you want to delete <span class="text-danger"><?= $product['product_name'] ?></span>?</p>
            ...
            <div class="row">
                ...
                <div class="col">
                    <form action="../actions/delete-product.php?product_id=<?= $product_id ?>" method="post">
